...
export class NotificationService {
  ...
  public createNotif(notif: Notification): Observable<Notification> {
    return this.http.post<Notification>("http://localhost:8080/FEEDBACK/api/addNotif", notif, httpOptions);
  }

  public loadNOtif(): Observable<Notification[]> {
    return this.http.get<Notification[]>("http://localhost:8080/FEEDBACK/api/loadNotif");
  }
  ...
  public NotifNonVu(): Observable<Notification[]> {
    return this.http.get<Notification[]>("http://localhost:8080/FEEDBACK/api/loadNotifNonVu");
  }
}
